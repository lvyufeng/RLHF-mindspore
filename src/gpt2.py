...
from mindnlp.models import GPT2LMHeadModel, GPT2Model
from mindnlp.models.gpt2.gpt2 import GPT2PreTrainedModel
...
def respond_to_batch(model, queries, txt_len=20, top_k=0, top_p=1.0):
    ...
    for i in range(txt_len):
        ...
        # Sample
        probs = ops.softmax(next_token_logits, axis=-1)
