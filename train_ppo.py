...
from mindnlp.transforms import RobertaTokenizer, GPT2Tokenizer

from src.gpt2 import GPT2HeadWithValueModel
...
# 情感分类模型
senti_tokenizer = RobertaTokenizer.from_pretrained('uer/roberta-base-finetuned-jd-binary-chinese')
senti_model = RobertaForSequenceClassification.from_pretrained('uer/roberta-base-finetuned-jd-binary-chinese')
sentiment_pipe = pipeline('sentiment-analysis', model=senti_model, tokenizer=senti_tokenizer)
